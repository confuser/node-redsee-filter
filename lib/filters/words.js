...
module.exports = function (client, res, msg, cb) {
  var blacklisted = []
    ...
    , wordWhitelist = function (word, encoding, callback) {
        ...
        client.sismember(client.prefix + 'redsee-whitelist:words', hash, function (error, exists) {
    ...
    , wordBlacklist = function (isEnd) {
        return function (word, encoding, callback) {
          var that = this
          client.sismember(client.prefix + 'redsee-blacklist:words', word, function (error, exists) {
            if (error) return callback(error)
            if (exists) {
              // Check if bypass
